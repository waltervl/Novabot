...
def main():
    ...
    cases = [
        ...
        ("replay_test_low_efficiency", "s0", "61", "75", "auto", "auto"),
        ("replay_test_low_efficiency", "s0", "61", "75", "0", "dir0"),
        ("replay_test_low_efficiency", "s0", "61", "75", "45", "dir45"),
        ("replay_test_low_efficiency", "s1", "37", "41", "auto", "auto"),
        ("replay_test_low_efficiency", "s1", "37", "41", "0", "dir0"),
        ("replay_test_low_efficiency", "s1", "37", "41", "45", "dir45"),
        ("debug_sh_home0_map1", "s0", "171", "120", "auto", "auto"),
        ("debug_sh_home0_map1", "s0", "171", "120", "0", "dir0"),
        ("debug_sh_home0_map1", "s0", "171", "120", "45", "dir45"),
        ("debug_sh_home0_map1", "s1", "97", "72", "auto", "auto"),
        ("debug_sh_home0_map1", "s1", "97", "72", "0", "dir0"),
