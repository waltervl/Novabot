export default {
  ...
  reanchorRunningHint: 'The mower sets the origin on the dock, drives back about 1 m to re-lock, then docks automatically. Do not touch it until this is done.',
  reanchorManualBackupHint: 'Manual backup: drive the mower back onto the dock (charging) with the joystick, then press Verify. Or try the automatic flow again.',
  ...
  reanchorMsgRelockSpin: 'Not locked yet, the mower turns 360 degrees...',
  reanchorMsgWaitAfterSpin: 'Waiting for re-lock after turning...',
  reanchorMsgRelockMoreBack: 'Not locked yet, backing up a little more...',
  reanchorMsgWaitAfterMore: 'Waiting for re-lock after the extra distance...',
  ...
  reanchorMsgErrRelockTimeout: 'Could not re-lock (no RUNNING + Fixed) after driving and turning. Drive the mower back to the dock manually with the joystick and press Verify.',
